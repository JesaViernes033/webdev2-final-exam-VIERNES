            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div id="wrapper">
                    ...
                    <div id="content" style="padding-top:120px;">
                        ...
                        <h5>Your Request is Successfully Received and Stored in the Database </h5>
                        <p>Would you like to fill out form again? </p>

                        <a href="/bible-study-request-form">
                        <button type="submit"class="btn btn-outline-primary btn-m ">Yes</button>
                        </a>
                        <br>
                       
                        <a href="/bible-study-requests">
                        <button type="submit" class="btn btn-outline-danger btn-m ">No, I want to view the list of request bible study</button>
                        </a>

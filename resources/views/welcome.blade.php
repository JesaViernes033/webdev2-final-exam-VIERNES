        ...
        <div class="relative flex justify-center min-h-screen  sm:items-center py-4 sm:pt-0">
            ...
            <div id="wrapper">
                ...
                <div id="content" >
                    ...
                    <h1><strong>Welcome to Bible Study Homepage!</strong></h1> 
                    <p>Do you want to request a bible study session? </p> 

                        <a href="/bible-study-request-form">
                        <button type="submit"class=" btn btn-primary btn-m " >Yes, Fill out Form</button>
                        </a>
                            <br> 
                        <a href="/bible-study-requests" >
                        <button type="submit" class="btn btn-danger btn-m" >No, I want to view list of Bible Study Requests</button>
                        </a>

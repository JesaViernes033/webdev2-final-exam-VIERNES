        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div id="wrapper">
                    ...
                    <div id="header">
                        <h1> Bible Study <span style="color:imperial;">Request Form </span> </h1> <br> <br>
                       

                    </div>

                        <table id="biblestudy" class="table table-m table-striped table-hover table-dark">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Full name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $biblestudy->id }}</td>
                                        <td>{{ $biblestudy->complete_name }}</td>
                                        <td>{{ $biblestudy->email_address }}</td>
                                        <td>{{ $biblestudy->contact_number }}</td>
                                        <td>{{ $biblestudy->birthdate }}</td>
                                        <td>{{ $biblestudy->religious_affiliation }}</td>
                                        <td>{{ $biblestudy->bible_study_date }}</td>
                                        <td>{{ $biblestudy->bible_study_time}}</td>
                                        <td>{{ $biblestudy->bible_study_location }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                ...
                <br> 
                         <a href="/">
                                <button type="submit" class="choice btn btn-outline-warning btn-m">Homepage</button>
                                </a>
                                <a href="/bible-study-request-form">
                                <button type="submit"class="choice btn btn-outline-warning btn-m">Fill Out Another Form</button>
                            </a>
